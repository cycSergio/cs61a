...
# Reviews Make sure you understand how Reviews data abstraction and Users data abstraction work.
...
def make_restaurant(name, location, categories, price, reviews):
    ...
    reviews是一个列表，包含不同人对于这个餐厅的所有评价，比如：
    soda_reviews = [make_review('Soda', 4.5), make_review('Soda',4)], 这个soda_reviews就是此处的参数reviews
...
def restaurant_ratings(restaurant):
    ...
    # 这里一开始我的写法是 [i[1] for i in restaurant[4]],但是这样违背了abstraction barrier。
    # 因为你不应该假定自己知道review它是一个list结构噢。
    # END Question 2